  ...
  return (
    <>
      <button
        ...
        style={{ width: 32, height: 32, borderRadius: '8px', border: 'none', background: 'rgba(227,0,27,0.1)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}
      >
